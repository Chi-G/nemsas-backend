...
class MonitoringBase(BaseModel):
    ...
    als: int = Field(0, alias="als")
    helicopters: int = Field(0, alias="helicopters")
    community_volunteers: int = Field(0, alias="communityVolunteers")
    ...
    paediatric_over_5: int = Field(0, alias="paediatricOver5")
    drowning: int = Field(0, alias="drowning")
    snake_bite: int = Field(0, alias="snakeBite")
    other_weapons: int = Field(0, alias="otherWeapons") 
    gunshot: int = Field(0, alias="gunshot")
    others: int = Field(0, alias="others")
    paediatric_under_5: int = Field(0, alias="paediatricUnder5")
    neonatal_under_5: int = Field(0, alias="neonatalUnder5")
    obstetric_accident: int = Field(0, alias="obstetricAccident")
    rta: int = Field(0, alias="rta")
...
class MonitoringUpdate(BaseModel):
    ...
    als: Optional[int] = Field(None, alias="als")
    helicopters: Optional[int] = Field(None, alias="helicopters")
    community_volunteers: Optional[int] = Field(None, alias="communityVolunteers")
    ...
    paediatric_over_5: Optional[int] = Field(None, alias="paediatricOver5")
    drowning: Optional[int] = Field(None, alias="drowning")
    snake_bite: Optional[int] = Field(None, alias="snakeBite")
    other_weapons: Optional[int] = Field(None, alias="otherWeapons") 
    gunshot: Optional[int] = Field(None, alias="gunshot")
    others: Optional[int] = Field(None, alias="others")
    paediatric_under_5: Optional[int] = Field(None, alias="paediatricUnder5")
    neonatal_under_5: Optional[int] = Field(None, alias="neonatalUnder5")
    obstetric_accident: Optional[int] = Field(None, alias="obstetricAccident")
    rta: Optional[int] = Field(None, alias="rta")
